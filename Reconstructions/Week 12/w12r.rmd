---
title: "Week 12 Reconstruction Xander"
---

## Original

![Original Visualization](Screenshot%202023-11-18%20at%2017-25-58%20270toWin%20-%202024%20Presidential%20Election%20Interactive%20Map.png)

## Comments

This visualization has the winning party's color filling the state, with a bit of alpha work done to represent how much each state is contributing, but they are binned pretty widely.

I'd like to further enhance the alpha values to give a more defined idea of which states are contributing more to the race.

I'm also not going to include the numbers as I'd like to see if the color alone would be enough for a general glimpse.
...
# Read the shapefile
states <- read_sf("cb_2018_us_state_20m/cb_2018_us_state_20m.shp")
...
![](Screenshot%202023-11-18%20at%2018.40.17.png)